                                ...
                                <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php if(is_array($list['list'])): $i = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td> <a href="<?php echo ($vo["pdf"]); ?>">
                                                <?php if($vo["pdf"] != ''): ?><img src="/Public/static/img/pdf.png" height="30"><?php endif; ?>
                                            </a></td>
                                           
                                          
                                            <td>
                                                <a href="/index.php/Admin/WalkThrough/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                                <a href="/index.php/Admin/WalkThrough/destroy/id/<?php echo ($vo["id"]); ?>">删除</a>
                                            </td>
