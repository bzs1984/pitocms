                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="/index.php/Admin/User/index" class="btn btn-primary">分类列表</a>
                                <a href="/index.php/Admin/User/create"  class="btn btn-info">添加分类</a>
                                ...
                                <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php if(is_array($list['list'])): $i = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td>
                                                <a href="/index.php/Admin/User/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                                <a href="/index.php/Admin/User/destroy/id/<?php echo ($vo["id"]); ?>">删除</a>
                                            </td>
