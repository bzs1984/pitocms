                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">问答管理</h3>
                               
                            </div>
                            <div class="panel-body">
                           
                                <a href="/index.php/Admin/Question/index" class="btn btn-primary">列表</a>
                                <a href="/index.php/Admin/Question/create"  class="btn btn-info">添加</a>
                                ...
                                <table  class="table table-striped table-bordered" cellspacing="0" width="100%">
                                    ...
                                    <tbody>
                                      <?php if(is_array($list['list'])): $i = 0; $__LIST__ = $list['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            ...
                                            <td><?php echo ($vo["values"]); ?></td>
                                            <td><?php echo ($vo["sames"]); ?></td>
                                            <td><?php echo ($vo["answers"]); ?></td>                                           
                                            <td><?php echo ($vo["clicks"]); ?></td>
                                            <td>
                                                <a href="/index.php/Admin/Question/edit/id/<?php echo ($vo["id"]); ?>">修改</a>
                                                <a href="/index.php/Admin/Question/destroy/id/<?php echo ($vo["id"]); ?>">删除</a>
                                            </td>
