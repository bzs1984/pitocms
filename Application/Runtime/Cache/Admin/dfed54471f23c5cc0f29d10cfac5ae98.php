...
<body>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="category">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="cname" value="<?php echo ($data["cname"]); ?>"  required class="form-control">
                                        </div>
                                    </div>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select data-placeholder="选择上级分类" class="chosen-select" name="pid">
                                               ...
                                               <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $data["pid"] ): ?>selected<?php endif; ?> ><?php echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                              </select>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                           <div class="row fileupload-buttonbar" style="padding-left:15px;">
                                            ...
                                            <img id="thumb_show"   data-holder-rendered="true" <?php if($data["thumb"] != ''): ?>src="<?php echo ($data["thumb"]); ?>"<?php endif; ?> />
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <script type="text/plain" id="editor" style="width:800px;height:200px"><?php echo (htmlspecialchars_decode($data["content"])); ?></script>
    ...
    function store()
    {
        ...
        $.post("/index.php/Admin/Category/update",data,function(rs)
        {
            if(rs.status==1)
            {
                alert(rs.content);
