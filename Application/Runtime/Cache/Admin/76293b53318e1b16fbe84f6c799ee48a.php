                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">编辑广告信息</h3>
                            ...
                            <div class="panel-body">
                                  <form action="/index.php/Admin/AdPostion/update" method="post" class="form-horizontal form-border" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select data-placeholder="选择上级分类" class="chosen-select" name="ad_id">
                                               ...
                                               <?php if(is_array($adlist)): $i = 0; $__LIST__ = $adlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $data["ad_id"] ): ?>selected<?php endif; ?>><?php echo ($vo["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                              </select>
