...
<body>
                ...
                <ul class="nano-content">
                    ...
                    <li class="sub-menu">
                        ...
                        <ul>
                            ...
                            <li><a href="/index.php/Admin/System/">全局设置</a>
                            </li>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="/index.php/Admin/Page/index" class="btn btn-primary">列表</a>
                                <a href="/index.php/Admin/Page/create"  class="btn btn-info">添加</a>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form1">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="keyword"  required class="form-control" placeholder="SEO关键词">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="col-sm-3 control-label">描述</label>
                                        <div class="col-sm-6">
                                            <textarea class="form-control" name="desc" placeholder="SEO描述"></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <script type="text/plain" id="editor" style="width:800px;height:350px"></script>
    ...
    function store()
    {
        ...
        $.post("/index.php/Admin/Page/store",data,function(rs)
        {
            if(rs.status==1)
            {
                alert(rs.content);
                window.location.href=" /index.php/Admin/Page";
                //location.reload();
            }
            else
            {
