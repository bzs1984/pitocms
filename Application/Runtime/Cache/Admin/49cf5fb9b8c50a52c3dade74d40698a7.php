                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <a href="/index.php/Admin/User/index" class="btn btn-primary">列表</a>
                                <a href="/index.php/Admin/User/create"  class="btn btn-info">添加</a>
       ...
       <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form1" action="/index.php/Admin/User/store" method="post">
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <label class="radio-inline">
                                                <input class="icheck" type="radio" checked="" name="gender">男</label>
                                            <label class="radio-inline">
                                                <input class="icheck" type="radio" name="gender">女</label>
