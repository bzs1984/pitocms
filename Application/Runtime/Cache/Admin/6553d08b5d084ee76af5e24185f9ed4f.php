        ...
        <aside class="sidebar">
            <div id="leftside-navigation" class="nano">
                <ul class="nano-content">
                    ...
                    <li class="sub-menu">
                        <a href="javascript:void(0);"><i class="fa fa-table"></i><span>攻略管理</span><i class="arrow fa fa-angle-right pull-right"></i></a>
                        <ul>
       ...
       <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" action="/index.php/Admin/Tour/store" enctype="multipart/form-data" method="post" id="form1">
