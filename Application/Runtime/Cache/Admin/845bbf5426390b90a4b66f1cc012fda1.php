...
<head>
    ...
    <!-- Vector Map  -->
    <link rel="stylesheet" href="/Public/static/plugins/jvectormap/css/jquery-jvectormap-1.2.2.css">
    <!-- ToDos  -->
    <link rel="stylesheet" href="/Public/static/plugins/todo/css/todos.css">
    <!-- Morris  -->
    <link rel="stylesheet" href="/Public/static/plugins/morris/css/morris.css">
    <!-- Fonts -->
...
<body>
        ...
        <aside class="sidebarRight">
            <div id="rightside-navigation ">
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar.gif" class="img-circle">
                        </div>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar1.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Jeffrey Ashby</h4>
                            <p>New York, NY</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar2.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>John Douey</h4>
                            <p>Dallas, TX</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar3.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ellen Baker</h4>
                            <p>London</p>
                ...
                <div class="list-contacts">
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar4.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Ivan Bella</h4>
                            <p>Tokyo, Japan</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static /img/avatar5.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
                            <h4>Gerald Carr</h4>
                            <p>Seattle, WA</p>
                    ...
                    <a href="javascript:void(0)" class="list-item">
                        <div class="list-item-image">
                            <img src="/Public/static/img/avatar6.gif" class="img-circle">
                        </div>
                        <div class="list-item-content">
    ...
    <!--Page Level JS-->
    <script src="/Public/static/plugins/countTo/jquery.countTo.js"></script>
    <script src="/Public/static/plugins/weather/js/skycons.js"></script>
    <!-- FlotCharts  -->
    <script src="/Public/static/plugins/flot/js/jquery.flot.min.js"></script>
    <script src="/Public/static/plugins/flot/js/jquery.flot.resize.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.canvas.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.image.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.categories.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.crosshair.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.errorbars.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.fillbetween.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.navigate.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.pie.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.selection.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.stack.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.symbol.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.threshold.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.colorhelpers.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.time.min.js"></script>
    <script src="/Public/static /plugins/flot/js/jquery.flot.example.js"></script>
    <!-- Morris  -->
    <script src="/Public/static /plugins/morris/js/morris.min.js"></script>
    <script src="/Public/static /plugins/morris/js/raphael.2.1.0.min.js"></script>
    <!-- Vector Map  -->
    <script src="/Public/static /plugins/jvectormap/js/jquery-jvectormap-1.2.2.min.js"></script>
    <script src="/Public/static /plugins/jvectormap/js/jquery-jvectormap-world-mill-en.js"></script>
    <!-- ToDo List  -->
    <script src="/Public/static /plugins/todo/js/todos.js"></script>
