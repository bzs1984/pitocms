...
<body>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                                ...
                                <a href="/index.php/Admin/Admin/index" class="btn btn-primary">管理员列表</a>
                                <a href="/index.php/Admin/Admin/create"  class="btn btn-info">添加管理员</a>
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal form-border" id="form1">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="username"  required class="form-control" value=<?php echo ($data["username"]); ?>>
                                        </div>
                                    </div>                  
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="password" name="password" class="form-control" placeholder="不改勿动">
                                        </div>
                                    </div>
    ...
    function store()
    {
        ...
        $.post("/index.php/Admin/Admin/update",data,function(rs)
        {
            if(rs.status==1)
            {
                alert(rs.content);
                window.location.href=" /index.php/Admin/Admin";
                //location.reload();
            }
            else
            {
