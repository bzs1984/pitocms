                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                          ...
                          <div class="panel-body">
                                ...
                                <a href="/index.php/Admin/Tour/index" class="btn btn-primary">文章列表</a>
                                <a href="/index.php/Admin/Tour/create"  class="btn btn-info">添加文章</a>
                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                ...
                                <form class="form-horizontal form-border" action="/index.php/Admin/Tour/update" enctype="multipart/form-data" method="post" id="form1">
                                    <div class="form-group">
                                      ...
                                      <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <select data-placeholder="选择上级分类" class="chosen-select" name="category_id">
                                               ...
                                               <?php if(is_array($catelist)): $i = 0; $__LIST__ = $catelist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if($vo["id"] == $data["category_id"] ): ?>selected<?php endif; ?>><?php echo ($vo["cname"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>    
                                              </select>
                                     ...
                                     <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <img src="<?php echo ($data["thumb"]); ?>" width="200"/>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="weight" class="form-control" value="<?php echo ($vo["weight"]); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" name="price" class="form-control" value="<?php echo ($vo["price"]); ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                ...
                                                <script type="text/plain" id="editor" name="content" style="width:800px;height:200px"><?php echo (htmlspecialchars_decode($data["content"])); ?></script>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!--style给定宽度可以影响编辑器的最终宽度-->
                                                <script type="text/plain" id="fee" name="fee_info" style="width:800px;height:200px"><?php echo (htmlspecialchars_decode($data["fee_info"])); ?></script>
                                     ...
                                     <div class="form-group">
                                            ...
                                            <div class="col-sm-6">
                                                <!--style给定宽度可以影响编辑器的最终宽度-->
                                                <script type="text/plain" id="route" name="route_info" style="width:800px;height:200px"><?php echo (htmlspecialchars_decode($data["route_info"])); ?></script>
